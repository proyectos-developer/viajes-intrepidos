...
export default function BlogTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 88 / proporcional}}>
                <div style={{width: '48%', height: 'auto'}}>
                    <CardBlogTablet proporcional={proporcional} blog={blogs[0]}/>
                </div>
                <div style={{width: '48%', height: 'auto'}}>
                    <CardBlogTablet proporcional={proporcional} blog={blogs[1]}/>
                </div>
            </div>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 88 / proporcional}}>
                <div style={{width: '48%', height: 'auto'}}>
                    <CardBlogTablet proporcional={proporcional} blog={blogs[2]}/>
                </div>
                <div style={{width: '48%', height: 'auto'}}>
                    <CardBlogTablet proporcional={proporcional} blog={blogs[3]}/>
                </div>
            </div>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 88 / proporcional}}>
                <div style={{width: '48%', height: 'auto'}}>
                    <CardBlogTablet proporcional={proporcional} blog={blogs[4]}/>
                </div>
                <div style={{width: '48%', height: 'auto'}}>
                    <CardBlogTablet proporcional={proporcional} blog={blogs[5]}/>
                </div>
            </div>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 88 / proporcional}}>
                <div style={{width: '48%', height: 'auto'}}>
                    <CardBlogTablet proporcional={proporcional} blog={blogs[6]}/>
                </div>
                <div style={{width: '48%', height: 'auto'}}>
                    <CardBlogTablet proporcional={proporcional} blog={blogs[7]}/>
                </div>
            </div>
        </div>
    )
