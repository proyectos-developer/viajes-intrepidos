        ...
        <div style={{width: '100%', height: 'auto', paddingLeft: 250 / proporcional, paddingRight: 250 / proporcional}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 88 / proporcional}}>
                <div style={{width: '31%', height: 'auto'}}>
                    <CardBlog proporcional={proporcional} blog={blogs[0]}/>
                </div>
                <div style={{width: '31%', height: 'auto'}}>
                    <CardBlog proporcional={proporcional} blog={blogs[1]}/>
                </div>
                <div style={{width: '31%', height: 'auto'}}>
                    <CardBlog proporcional={proporcional} blog={blogs[2]}/>
                </div>
            </div>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 88 / proporcional}}>
                <div style={{width: '31%', height: 'auto'}}>
                    <CardBlog proporcional={proporcional} blog={blogs[3]}/>
                </div>
                <div style={{width: '31%', height: 'auto'}}>
                    <CardBlog proporcional={proporcional} blog={blogs[4]}/>
                </div>
                <div style={{width: '31%', height: 'auto'}}>
                    <CardBlog proporcional={proporcional} blog={blogs[5]}/>
                </div>
            </div>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 88 / proporcional}}>
                <div style={{width: '31%', height: 'auto'}}>
                    <CardBlog proporcional={proporcional} blog={blogs[6]}/>
                </div>
                <div style={{width: '31%', height: 'auto'}}>
                    <CardBlog proporcional={proporcional} blog={blogs[7]}/>
                </div>
                <div style={{width: '31%', height: 'auto'}}>
                    <CardBlog proporcional={proporcional} blog={blogs[8]}/>
                </div>
            </div>
        </div>
    )
