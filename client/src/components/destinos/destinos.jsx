...
import CardDestino from './card/destino.jsx'

export default function Destinos({proporcional}) {
            ...
            <div style={{width: '100%', height: 'auto', paddingLeft: 250 / proporcional, paddingRight: 250 / proporcional}}>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 80 / proporcional}}>
                    <div style={{width: '31%', height: 'auto'}}>
                        <CardDestino proporcional={proporcional} destino={destinos[0]}/>
                    </div>
                    <div style={{width: '31%', height: 'auto'}}>
                        <CardDestino proporcional={proporcional} destino={destinos[1]}/>
                    </div>
                    <div style={{width: '31%', height: 'auto'}}>
                        <CardDestino proporcional={proporcional} destino={destinos[2]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 80 / proporcional}}>
                    <div style={{width: '31%', height: 'auto'}}>
                        <CardDestino proporcional={proporcional} destino={destinos[3]}/>
                    </div>
                    <div style={{width: '31%', height: 'auto'}}>
                        <CardDestino proporcional={proporcional} destino={destinos[4]}/>
                    </div>
                    <div style={{width: '31%', height: 'auto'}}>
                        <CardDestino proporcional={proporcional} destino={destinos[5]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 80 / proporcional}}>
                    <div style={{width: '31%', height: 'auto'}}>
                        <CardDestino proporcional={proporcional} destino={destinos[6]}/>
                    </div>
                    <div style={{width: '31%', height: 'auto'}}>
                        <CardDestino proporcional={proporcional} destino={destinos[7]}/>
                    </div>
                    <div style={{width: '31%', height: 'auto'}}>
                        <CardDestino proporcional={proporcional} destino={destinos[8]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 80 / proporcional}}>
                    <div style={{width: '31%', height: 'auto'}}>
                        <CardDestino proporcional={proporcional} destino={destinos[9]}/>
                    </div>
                    <div style={{width: '31%', height: 'auto'}}>
                        <CardDestino proporcional={proporcional} destino={destinos[10]}/>
                    </div>
                    <div style={{width: '31%', height: 'auto'}}>
                        <CardDestino proporcional={proporcional} destino={destinos[11]}/>
                    </div>
                </div>
            </div>
        </div>
