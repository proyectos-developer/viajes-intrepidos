...
import CardDestinoCell from './card/destinocell.jsx'

export default function DestinosCell({proporcional}) {
            ...
            <div style={{width: '100%', height: 'auto', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '90%', height: 'auto'}}>
                        <CardDestinoCell proporcional={proporcional} destino={destinos[0]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '90%', height: 'auto'}}>
                        <CardDestinoCell proporcional={proporcional} destino={destinos[1]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '90%', height: 'auto'}}>
                        <CardDestinoCell proporcional={proporcional} destino={destinos[2]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '90%', height: 'auto'}}>
                        <CardDestinoCell proporcional={proporcional} destino={destinos[3]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '90%', height: 'auto'}}>
                        <CardDestinoCell proporcional={proporcional} destino={destinos[4]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '90%', height: 'auto'}}>
                        <CardDestinoCell proporcional={proporcional} destino={destinos[5]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '90%', height: 'auto'}}>
                        <CardDestinoCell proporcional={proporcional} destino={destinos[6]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '90%', height: 'auto'}}>
                        <CardDestinoCell proporcional={proporcional} destino={destinos[7]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '90%', height: 'auto'}}>
                        <CardDestinoCell proporcional={proporcional} destino={destinos[8]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '90%', height: 'auto'}}>
                        <CardDestinoCell proporcional={proporcional} destino={destinos[9]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '90%', height: 'auto'}}>
                        <CardDestinoCell proporcional={proporcional} destino={destinos[10]}/>
                    </div>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 40 / proporcional}}>
                    <div style={{width: '90%', height: 'auto'}}>
                        <CardDestinoCell proporcional={proporcional} destino={destinos[11]}/>
                    </div>
                </div>
            </div>
        </div>
