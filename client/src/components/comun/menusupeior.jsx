...
export default function MenuSuperior({proporcional}) {
    ...
    return (
        <div className='shadow' style={{width: '100%', height: 120 / proporcional, paddingLeft: 50 / proporcional, paddingRight: 50 / proporcional, background: 'transparent'}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 120 / proporcional}}>
                <div style={{width: '25%', height: 120 / proporcional, paddingTop: 40 / proporcional, paddingBottom: 40 / proporcional}}>
                ...
                <div className='d-flex justify-content-end' 
                    style={{width: '25%', height: 120 / proporcional, paddingTop: 40 / proporcional, paddingBottom: 40 / proporcional}}>
