...
export default function Footer({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', background: '#007bff', paddingLeft: 250 / proporcional, paddingRight: 250 / proporcional}}>
            <div className='d-flex justify-conten-between' style={{width: '100%', height: 'auto', borderBottom: '1px solid rgba(255, 255, 255, 0.6)', paddingTop: 120 / proporcional,
