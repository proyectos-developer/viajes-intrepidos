...
export default function FooterCell({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', background: '#007bff', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            <div className='d-flex justify-conten-center' style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional,
            ...
            <div style={{width: '100%', height: 'auto', paddingTop: 22 / proporcional, paddingBottom: 22 / proporcional}}>
                ...
                <div className='d-flex justify-content-end' style={{width: '100%', height: 26 / proporcional}}>
