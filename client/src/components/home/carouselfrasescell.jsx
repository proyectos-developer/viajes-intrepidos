...
export default function CarouselFrasesCell({proporcional}) {

    return (
        <div style={{width: '100%', height: 500 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, background: 'rgba(0, 123, 251, 0.6)'}}>
                ...
                <div className='position-absolute top-50 start-50 translate-middle' style={{width: '100%', height: 'auto'}}>
                    <div id='carouselhomefrases' className='carousel slide' style={{width: '100%', height: 'auto'}}>
                        <div className='carousel-inner' style={{width: '100%', height: 'auto'}}>
                            <div style={{width: '100%', height: 'auto', paddingLeft: 0 / proporcional, paddingRight: 0 / proporcional}} className='carousel-item active'
