...
import image from '../../assets/image/home/home_main_tablet.png'
...
export default function BannerPrincipal({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 950 / proporcional, backgroundImage: `url(${image})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
            <div style={{width: '100%', height: 950 / proporcional, paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
                <div className='position-relative' style={{width: '100%', height: 950 / proporcional}}>
                    <div className='position-absolute start-50 top-50 translate-middle' style={{width: '100%', height: 'auto', marginTop: 85 / proporcional}}>
                        <div style={{width: '100%', height: 'auto'}}>
                            <div style={{width: 450 / proporcional, height: 'auto'}}>
                            ...
                            <div className='rounded' style={{width: '100%', height: 'auto', marginTop: 114 / proporcional, background: '#f9f9f9',
                                    padding: 26 / proporcional, paddingBottom: 15 / proporcional}}>
                                <div style={{width: '100%', height: 66 / proporcional}}>
                                    <div className='d-flex justify-content-between' style={{width: '100%', height: 56 / proporcional, marginBottom: 10 / proporcional}}>
                                        <div style={{width: '23%', height: 56 / proporcional}}>
                                            <input 
                                                id='nombres'
                                                type='default'
