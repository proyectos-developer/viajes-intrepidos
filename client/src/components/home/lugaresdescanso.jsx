...
export default function LugaresDescanso({proporcional}) {

    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 150 / proporcional, paddingBottom: 150 / proporcional}}>
                    ...
                    <div style={{width: '38%', height: 'auto'}}>
                        <div style={{width: '100%', height: 250 / proporcional, marginBottom: 20 / proporcional}}>
                            <ReactPlayer
                                ...
                                url= {video_00}
                                width='100%'
                                height={250 / proporcional}
                                style={{background: '#efefef'}}
                                playing={true}
                                loop={true}/>
                        </div>
                        <div style={{width: '100%', height: 250 / proporcional}}>
                            <ReactPlayer
                                className=''
                                url= {video_01}
                                width='100%'
