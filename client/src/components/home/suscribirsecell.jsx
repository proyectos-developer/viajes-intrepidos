...
export default function SuscribirseCell({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', background: 'rgba(0, 123, 251, 0.6)', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            <div style={{width: '100%', height: 'auto', paddingTop: 51 / proporcional, paddingBottom: 51 / proporcional}}>
                <div className='' style={{width: '100%', height: 'auo'}}>
