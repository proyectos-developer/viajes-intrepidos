...
export default function LugaresDescansoTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional}}>
            <div style={{width: '100%', height: 'auto', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    <div style={{width: '100%', height: 470 / proporcional, marginBottom: 20 / proporcional}}>
                        <ReactPlayer
                            className=''
                            url= {video_00}
                            width='100%'
                            height={470 / proporcional}
                            style={{background: '#efefef'}}
                            playing={true}
                            loop={true}/>
                    </div>
                    <div style={{width: '100%', height: 470 / proporcional}}>
                        <ReactPlayer
                            className=''
                            url= {video_01}
                            width='100%'
